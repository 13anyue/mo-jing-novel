...
/* V45 loader: keep engines/data modules, but remove the previous reference UI layer.
   The new platform shell is intentionally loaded last and owns presentation/navigation. */
(function(){
  const css=['css/ui-overhaul.css','css/interaction-safety.css','css/ui-v3.css','css/ui-v4.css','css/ui-v5.css','css/platform-v2.css','css/platform-v2-fix.css','css/world-state-v3.css','css/platform-v6.css','css/platform-v7.css','css/runtime-v7.css','css/runtime-v8.css','css/platform-v8.css','css/platform-v8-complete.css','css/mo-design-2026.css'];
  ...
  load('js/material-library.js')
    ...
    .then(()=>load('js/platform-v6.js'))
    .then(()=>load('js/platform-v6-qa.js'))
    .then(()=>load('js/runtime-v7.js'))
    .then(()=>load('js/platform-v8.js'))
    .then(()=>load('js/platform-v8-qa.js'))
    .then(()=>load('js/platform-v8-complete.js'))
    .then(()=>load('js/mo-design-2026.js'))
