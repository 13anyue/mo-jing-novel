...
/* v26 loader：Visual Novel Design System v3 + 世界背面 + 群像运行时。 */
(function(){
  const css=['css/ui-overhaul.css','css/interaction-safety.css','css/ui-reference.css','css/ui-scene-pages.css','css/ui-v3.css'];
  ...
  load('js/material-library.js').then(()=>load('js/ui-overhaul.js')).then(()=>load('js/platform-upgrade.js')).then(()=>load('js/interaction-safety.js')).then(()=>load('js/memory-autocapture.js')).then(()=>load('js/ui-reference.js')).then(()=>load('js/ui-scene-pages.js')).then(()=>load('js/world-simulation.js')).then(()=>load('js/world-simulation-v2.js')).then(()=>load('js/ui-v3.js')).catch(e=>console.warn('[墨境平台] 模块加载失败：',e));
})();
